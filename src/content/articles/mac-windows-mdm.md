...
「エンジニアはMac、それ以外はWindowsなんですが、管理はどうするのが正解ですか」
こういったご質問を受けることがあります。

選択肢は事実上2つに絞られます。**Intune 一本化**か、**Windows は Intune、Mac は Jamf Pro という併用構成**か。どちらも実績のある構成のため、どちらか一方だけが正解というわけではありません。ただ、自社がどちら寄りかを判断する軸ははっきりしています。
