...
ここで大事なのは、同じ「会社が設定を配る」でも、どの層に配るかで意味がまったく変わることです。ユーザー設定の層に配った内容は、あくまで初期値の提案（推奨設定）で、ユーザー自身の手でいつでも書き換えられます。管理設定の層に配って、はじめて書き換えられない強制になります。前回の記事で「推奨設定だけ配って統制した気になっているケースがある」と書いたのは、この違いの話です。
